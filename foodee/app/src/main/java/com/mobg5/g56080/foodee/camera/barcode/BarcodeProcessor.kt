...
import com.mobg5.g56080.foodee.camera.CameraReticleAnimator
import com.mobg5.g56080.foodee.camera.FrameProcessorBase
...
import com.mobg5.g56080.foodee.util.InputInfo
import java.io.IOException

/** A processor to run the barcode detector.  */
class BarcodeProcessor(graphicOverlay: GraphicOverlay, private val workflowModel: WorkflowViewModel) :
    ...
    override fun onSuccess(
        ...
        if (barcodeInCenter == null) {
            ...
            workflowModel.setWorkflowState(WorkflowViewModel.WorkflowState.DETECTING)
        } else {
            ...
            if (sizeProgress < 1) {
                ...
                workflowModel.setWorkflowState(WorkflowViewModel.WorkflowState.CONFIRMING)
            } else {
                ...
                if (PreferenceUtils.shouldDelayLoadingBarcodeResult(graphicOverlay.context)) {
                    ...
                    workflowModel.setWorkflowState(WorkflowViewModel.WorkflowState.SEARCHING)
                } else {
                    workflowModel.setWorkflowState(WorkflowViewModel.WorkflowState.DETECTED)
        ...
        return ValueAnimator.ofFloat(0f, endProgress).apply {
            ...
            addUpdateListener {
                if ((animatedValue as Float).compareTo(endProgress) >= 0) {
                    graphicOverlay.clear()
                    workflowModel.setWorkflowState(WorkflowViewModel.WorkflowState.SEARCHED)
